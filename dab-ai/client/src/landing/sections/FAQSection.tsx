...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'We provide free migration assistance for all paid plans. Our team will help export your data from Greenhouse, Lever, Ashby, or any other ATS and import it into DAB AI seamlessly.',
  },
];
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center mb-10 sm:mb-12">
          ...
          <p className="text-muted-foreground">
            Everything you need to know about DAB AI.
          </p>
        </div>
