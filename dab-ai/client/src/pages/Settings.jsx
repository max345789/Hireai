...
export default function Settings() {
  ...
  const [settingsSection, setSettingsSection] = useState('essentials');
...
<script src="${base}/widget.js"></script>`;
  ...
  function previewWidget() {
    ...
    if (!win) return;
    const wid = widgetCreds.widgetId || 'YOUR_WIDGET_ID';
    const cfg = `window.DABAIConfig={widgetId:'${wid}',agencyName:'${
      ...
      <div className="mx-auto max-w-6xl space-y-4">
        ...
        <header className="flex flex-wrap items-center justify-between gap-3 rounded-3xl bg-white px-5 py-3.5 shadow-card">
          <div>
            ...
            <p className="text-xs text-gray-400">Start with the essentials. Open channels, account, or advanced tools only when needed.</p>
          </div>
          <Link
            to="/dashboard"
        ...
        <div className="flex flex-wrap gap-2 rounded-3xl bg-white p-3 shadow-card">
          {[
        ...
        <div className="grid grid-cols-1 gap-4 xl:grid-cols-[1fr_360px]">
          ...
          {(settingsSection === 'account' || settingsSection === 'essentials') && (
          ...
          {/* ── Main form ── */}
          {(settingsSection === 'essentials' || settingsSection === 'channels') && (
          <form onSubmit={saveSettings} className="space-y-5 rounded-3xl bg-white p-5 shadow-card">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              {[
                ...
                settingsSection === 'channels' || !['twilioKey', 'gmailConfig'].includes(field)
